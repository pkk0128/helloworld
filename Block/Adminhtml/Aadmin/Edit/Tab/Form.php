 ...
 * Time: 4:17 PM
 */
class Inchoo_HelloDeveloper_Block_Adminhtml_Aadmin_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form

{
...

    {
      ...
      /*  $fieldset->addField('age','text',array(
        ...
        } elseif ( Mage::registry('aadmin') ) {

            $form->setValues(Mage::registry('aadmin')->getData());
