 ...
 * Time: 1:32 PM
 */
class Inchoo_HelloDeveloper_Block_Adminhtml_Aadmin_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        $collection = Mage::getModel('student/aadmin')->getCollection();
...
//        ));
    ...
    {
        return $this->getUrl('*/*/gridf', array('_current'=>true));
    }
